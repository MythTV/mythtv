...
class GameHandler
{
  public:
    ...
    static void EditSettings(MythMainWindow *parent, RomInfo *romdata);
    static void EditSystemSettings(MythMainWindow *parent, RomInfo *romdata);
    static RomInfo* CreateRomInfo(RomInfo* parent);

    virtual void start_game(RomInfo *romdata) = 0;
    virtual void edit_settings(MythMainWindow *parent, RomInfo *romdata) = 0;
    virtual void edit_system_settings(MythMainWindow *parent,
                                      RomInfo *romdata) = 0;
