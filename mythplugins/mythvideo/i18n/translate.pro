...
TRANSLATIONS += mythvideo_nl.ts mythvideo_de.ts mythvideo_da.ts
...
TRANSLATIONS += mythvideo_cs.ts mythvideo_hu.ts mythvideo_el.ts
TRANSLATIONS += mythvideo_en_gb.ts mythvideo_en_us.ts
