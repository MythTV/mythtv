...
TRANSLATIONS += mythweather_da.ts mythweather_pt.ts mythweather_sv.ts
...
TRANSLATIONS += mythweather_ru.ts mythweather_cs.ts mythweather_nb.ts
TRANSLATIONS += mythweather_hu.ts mythweather_et.ts mythweather_en_gb.ts
