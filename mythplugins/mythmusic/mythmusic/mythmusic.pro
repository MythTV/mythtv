...
HEADERS += metaioflacvorbiscomment.h metaioavfcomment.h metaiomp4.h
HEADERS += metaiowavpack.h metaioid3.h
...
SOURCES += metaioflacvorbiscomment.cpp metaioavfcomment.cpp metaiomp4.cpp
SOURCES += metaiowavpack.cpp metaioid3.cpp
