...
class MarkupCodes
{
  ...
  public:
    ...
    static const char collection_is_editable = 106;
    static const char collection_is_ripable  = 107;
    static const char collection_generation  = 108;
    static const char update_type            = 109;
    static const char total_items            = 110;
    static const char added_items            = 111;
    static const char deleted_items          = 112;
    static const char deleted_item           = 113;
    static const char item_type              = 114;
    static const char item_id                = 115;
    static const char item_rating            = 116;
    static const char item_last_played       = 117;
    static const char item_play_count        = 118;
    static const char item_year              = 119;
    static const char item_track             = 120;
    static const char item_length            = 121;
