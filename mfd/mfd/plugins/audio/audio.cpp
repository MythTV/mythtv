    ...
    state_of_play_mutex->lock();
        ...
        else if (url.protocol() == "daap")
        {
            ...
            else
            {
                ...
                if (daap_server_type == MST_daap_itunes60)
                {
                    input = new DaapInput(this, url, DAAP_SERVER_ITUNES60);
                }
                else if (daap_server_type == MST_daap_itunes50)
                {
                ...
                else if (daap_server_type == MST_daap_itunes48)
                {
                    input = new DaapInput(this, url, DAAP_SERVER_ITUNES48);
                }
