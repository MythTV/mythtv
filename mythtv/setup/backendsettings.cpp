...
BackendSettings::BackendSettings(MythContext* context):
    ...
    VerticalConfigurationGroup* group = new VerticalConfigurationGroup();
    group->addChild(new RecordFilePrefix());
    group->addChild(new TVFormat());
    group->addChild(new FreqTable());
    addChild(group);
}
