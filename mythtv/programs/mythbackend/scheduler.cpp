...
"     AND "
"     ( "
"      (program.programid IS NOT NULL AND program.programid <> '' AND (program.seriesid IS NULL OR program.seriesid = '' OR program.programid NOT LIKE '%0000') AND program.programid = oldrecorded.programid) "
"      OR "
"      ( "
"       ((record.dupmethod & 0x08) = 0) "
"       AND "
...
"     AND "
"     ( "
"      (program.programid IS NOT NULL AND program.programid <> '' AND (program.seriesid IS NULL OR program.seriesid = '' OR program.programid NOT LIKE '%0000') AND program.programid = recorded.programid) "
"      OR "
"      ( "
"       ((record.dupmethod & 0x08) = 0) "
"       AND "
