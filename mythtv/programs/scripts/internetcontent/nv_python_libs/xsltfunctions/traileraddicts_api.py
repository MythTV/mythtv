...
class xpathFunctions(object):
    ...
    """
    def __init__(self):
        self.functList = ['traileraddictsLinkGenerationMovie', 'traileraddictsLinkGenerationClip']
...
######################################################################################################
    ...
    def traileraddictsLinkGenerationMovie(self, context, *args):
        ...
        if self.persistence.has_key('traileraddictsLinkGenerationMovie'):
            ...
            self.persistence['traileraddictsLinkGenerationMovie']['embedRSS'] = etree.parse(u'http://www.traileraddict.com/embedrss')
