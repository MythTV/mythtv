...
# Author: R.D. Vaughan
# Purpose:
#   This python script is intended to perform a mashup of various TedTalks Internet media sources
...
#
# Design:
#   1) Read "~/.mythtv/MythNetvision/userGrabberPrefs/tedtalks.xml" configuration file
...
(Option Help)
> ./tedtalks.py -h
Usage: ./tedtalks.py -hduvlST [parameters] <search text>
...
<grabber>
  ...
  <thumbnail>tedtalks.png</thumbnail>
  <command>tedtalks.py</command>
  <type>video</type>
  <description>TED is a small nonprofit devoted to Ideas Worth Spreading.</description>
  <version>v0.10</version>
  <search>true</search>
  <tree>true</tree>
</grabber>

> ./tedtalks.py -S "Africa"

> ./tedtalks.py -T
'''
__search_max_page_items__ = 10
__tree_max_page_items__ = 10
...
# Used for debugging
#import nv_python_libs.tedtalks.tedtalks_api as target
try:
    ...
    sys.stderr.write('''
The subdirectory "nv_python_libs/tedtalks" containing the modules tedtalks_api and
tedtalks_exceptions.py (v0.1.0 or greater),
...
if __name__ == '__main__':
    ...
    main.grabberInfo['command'] = u'tedtalks.py'
    main.grabberInfo['mashup_title'] = __mashup_title__
    main.grabberInfo['author'] = __author__
    main.grabberInfo['thumbnail'] = 'tedtalks.png'
    main.grabberInfo['type'] = ['video', ]
    main.grabberInfo['desc'] = u"TED is a small nonprofit devoted to Ideas Worth Spreading."
