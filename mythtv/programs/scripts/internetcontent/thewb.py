...
if __name__ == '__main__':
    ...
    main.grabberInfo['command'] = 'thewb.py'
    ...
    main.grabberInfo['desc'] = "Watch full episodes of your favorite shows on The WB.com, like Friends, The O.C., Veronica Mars, Pushing Daisies, Smallville, Buffy The Vampire Slayer, One Tree Hill and Gilmore Girls."
