...
class LOGMASK( object ):
    ...
    MOST        = 0b1011111111110111111111111111
    NONE        = 0b0000000000000000000000000000

    GENERAL     = 0b0000000000000000000000000001
    RECORD      = 0b0000000000000000000000000010
    PLAYBACK    = 0b0000000000000000000000000100
    CHANNEL     = 0b0000000000000000000000001000
    OSD         = 0b0000000000000000000000010000
    FILE        = 0b0000000000000000000000100000
    SCHEDULE    = 0b0000000000000000000001000000
    NETWORK     = 0b0000000000000000000010000000
    COMMFLAG    = 0b0000000000000000000100000000
    AUDIO       = 0b0000000000000000001000000000
    LIBAV       = 0b0000000000000000010000000000
    JOBQUEUE    = 0b0000000000000000100000000000
    SIPARSER    = 0b0000000000000001000000000000
    EIT         = 0b0000000000000010000000000000
    VBI         = 0b0000000000000100000000000000
    DATABASE    = 0b0000000000001000000000000000
    DSMCC       = 0b0000000000010000000000000000
    MHEG        = 0b0000000000100000000000000000
    UPNP        = 0b0000000001000000000000000000
    SOCKET      = 0b0000000010000000000000000000
    XMLTV       = 0b0000000100000000000000000000
    DVBCAM      = 0b0000001000000000000000000000
    MEDIA       = 0b0000010000000000000000000000
    IDLE        = 0b0000100000000000000000000000
    CHANNELSCAN = 0b0001000000000000000000000000
    SYSTEM      = 0b0010000000000000000000000000
    TIMESTAMP   = 0b0100000000000000000000000000
    HTTP        = 0b1000000000000000000000000000
