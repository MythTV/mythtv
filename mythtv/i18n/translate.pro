SOURCES += ../libs/libmyth/backendselect.cpp
...
SOURCES += ../libs/libmyth/mythmediamonitor.cpp
SOURCES += ../libs/libmyth/mythterminal.cpp
SOURCES += ../libs/libmyth/mythwizard.cpp
SOURCES += ../libs/libmyth/schemawizard.cpp
SOURCES += ../libs/libmyth/settings.cpp
SOURCES += ../libs/libmyth/storagegroup.cpp
SOURCES += ../libs/libmyth/uilistbtntype.cpp
SOURCES += ../libs/libmyth/uitypes.cpp
SOURCES += ../libs/libmythtv/avformatdecoder.cpp
SOURCES += ../libs/libmythtv/cardutil.cpp
SOURCES += ../libs/libmythtv/cc608decoder.cpp
SOURCES += ../libs/libmythtv/channeleditor.cpp
SOURCES += ../libs/libmythtv/channelsettings.cpp
SOURCES += ../libs/libmythtv/channelutil.cpp
...
SOURCES += ../libs/libmythtv/DVDRingBuffer.cpp
...
SOURCES += ../libs/libmythtv/remoteutil.cpp
...
SOURCES += ../libs/libmythtv/signalmonitorvalue.cpp
SOURCES += ../libs/libmythtv/siscan.cpp
SOURCES += ../libs/libmythtv/sr_dialog.cpp
...
SOURCES += ../libs/libmythtv/transporteditor.cpp
SOURCES += ../libs/libmythtv/tv.cpp
SOURCES += ../libs/libmythtv/tv_play.cpp
SOURCES += ../libs/libmythtv/tv_rec.cpp
SOURCES += ../libs/libmythtv/videodisplayprofile.cpp
...
SOURCES += ../libs/libmythtv/channelscan/channelimporter.cpp
SOURCES += ../libs/libmythtv/channelscan/channelscan_sm.cpp
SOURCES += ../libs/libmythtv/channelscan/channelscanner.cpp
SOURCES += ../libs/libmythtv/channelscan/channelscanner_gui.cpp
SOURCES += ../libs/libmythtv/channelscan/frequencytablesetting.cpp
SOURCES += ../libs/libmythtv/channelscan/inputselectorsetting.cpp
SOURCES += ../libs/libmythtv/channelscan/multiplexsetting.cpp
SOURCES += ../libs/libmythtv/channelscan/scanmonitor.cpp
SOURCES += ../libs/libmythtv/channelscan/scanprogresspopup.cpp
SOURCES += ../libs/libmythtv/channelscan/scanwizardconfig.cpp
SOURCES += ../libs/libmythtv/iptv/iptvchannelfetcher.cpp
SOURCES += ../libs/libmythtv/mpeg/atsctables.cpp
SOURCES += ../libs/libmythtv/mpeg/dvbdescriptors.cpp
SOURCES += ../libs/libmythui/mythdialogbox.cpp
SOURCES += ../libs/libmythui/mythprogressdialog.cpp
SOURCES += ../libs/libmythui/myththemedmenu.cpp
SOURCES += ../libs/libmythui/mythuihelper.cpp
SOURCES += ../libs/libmythui/mythuiwebbrowser.cpp
SOURCES += ../libs/libmythupnp/upnpcds.cpp
SOURCES += ../programs/mythbackend/httpstatus.cpp
SOURCES += ../programs/mythbackend/scheduler.cpp
SOURCES += ../programs/mythcommflag/ClassicCommDetector.cpp
SOURCES += ../programs/mythcommflag/CommDetector2.cpp
SOURCES += ../programs/mythcommflag/main.cpp
SOURCES += ../programs/mythfilldatabase/filldata.cpp
SOURCES += ../programs/mythfilldatabase/main.cpp
...
SOURCES += ../programs/mythlcdserver/lcdprocclient.cpp
SOURCES += ../programs/mythtranscode/main.cpp
SOURCES += ../programs/mythtranscode/transcode.cpp
SOURCES += ../programs/mythtv-setup/backendsettings.cpp
SOURCES += ../programs/mythtv-setup/checksetup.cpp
SOURCES += ../programs/mythtv-setup/main.cpp
