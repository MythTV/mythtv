...
TRANSLATIONS += mythfrontend_nb.ts mythfrontend_is.ts mythfrontend_pt_br.ts
TRANSLATIONS += mythfrontend_cs.ts mythfrontend_et.ts mythfrontend_en_gb.ts
TRANSLATIONS += mythfrontend_pl.ts mythfrontend_tr.ts mythfrontend_en_us.ts
