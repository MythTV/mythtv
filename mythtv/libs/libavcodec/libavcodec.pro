...
inc.files = avcodec.h x86/mmx.h opt.h
...
contains( CONFIG_ATRAC3_DECODER, yes )          { SOURCES *= atrac3.c }
...
contains( CONFIG_FLAC_ENCODER, yes )            { SOURCES *= flacenc.c flacdata.c lpc.c }
...
contains( CONFIG_H263_VAAPI_HWACCEL, yes )      { SOURCES *= h263dec.c h263.c h263_parser.c mpeg12data.c mpegvideo.c error_resilience.c vaapi_mpeg4.c }
...
contains( CONFIG_H264_DECODER, yes )            { SOURCES *= h264.c h264idct.c h264pred.c cabac.c mpegvideo.c error_resilience.c }
contains( CONFIG_H264_ENCODER, yes )            { SOURCES *= h264enc.c h264dspenc.c }
contains( CONFIG_H264_VDPAU_DECODER, yes )      { SOURCES *= h264.c h264idct.c h264pred.c h264_parser.c cabac.c mpegvideo.c error_resilience.c }
...
contains( CONFIG_MLP_DECODER, yes )             { SOURCES *= mlpdec.c mlp_parser.c mlp.c mlpdsp.c }
...
contains( CONFIG_MPEG_VDPAU_DECODER, yes )      { SOURCES *= mpeg12.c mpeg12data.c mpegvideo.c error_resilience.c }
contains( CONFIG_MPEG1_VDPAU_DECODER, yes )     { SOURCES *= mpeg12.c mpeg12data.c mpegvideo.c error_resilience.c }
contains( CONFIG_MPEG_XVMC_DECODER, yes )       { SOURCES *= mpegvideo_xvmc.c mpeg12.c mpeg12data.c mpegvideo.c error_resilience.c }
...
contains( CONFIG_MPEG2_VAAPI_HWACCEL, yes )     { SOURCES *= mpeg12.c mpeg12data.c mpegvideo.c error_resilience.c vaapi_mpeg2.c }
...
contains( CONFIG_MPEG4_VAAPI_HWACCEL, yes )     { SOURCES *= h263dec.c h263.c mpeg4video_parser.c mpeg12data.c mpegvideo.c error_resilience.c vaapi_mpeg4.c }
...
contains( CONFIG_PAM_DECODER, yes )             { SOURCES *= pnmenc.c pnm.c }
contains( CONFIG_PAM_ENCODER, yes )             { SOURCES *= pnmenc.c }
contains( CONFIG_PBM_DECODER, yes )             { SOURCES *= pnmenc.c pnm.c }
contains( CONFIG_PBM_ENCODER, yes )             { SOURCES *= pnmenc.c }
contains( CONFIG_PCX_DECODER, yes )             { SOURCES *= pcx.c }
contains( CONFIG_PCX_ENCODER, yes )             { SOURCES *= pcxenc.c }
contains( CONFIG_PGM_DECODER, yes )             { SOURCES *= pnmenc.c pnm.c }
contains( CONFIG_PGM_ENCODER, yes )             { SOURCES *= pnmenc.c }
contains( CONFIG_PGMYUV_DECODER, yes )          { SOURCES *= pnmenc.c pnm.c }
contains( CONFIG_PGMYUV_ENCODER, yes )          { SOURCES *= pnmenc.c }
contains( CONFIG_PNG_DECODER, yes )             { SOURCES *= png.c pngdec.c }
contains( CONFIG_PNG_ENCODER, yes )             { SOURCES *= png.c pngenc.c }
contains( CONFIG_PPM_DECODER, yes )             { SOURCES *= pnmenc.c pnm.c }
contains( CONFIG_PPM_ENCODER, yes )             { SOURCES *= pnmenc.c }
contains( CONFIG_PTX_DECODER, yes )             { SOURCES *= ptx.c }
contains( CONFIG_QCELP_DECODER, yes )           { SOURCES *= qcelpdec.c qcelp_lsp.c celp_math.c celp_filters.c acelp_vectors.c }
...
contains( CONFIG_SVQ3_DECODER, yes )            { SOURCES *= h264.c h264idct.c h264pred.c cabac.c mpegvideo.c error_resilience.c svq1dec.c svq1.c h263.c }
...
contains( CONFIG_TRUEHD_DECODER, yes )          { SOURCES *= mlpdec.c mlp_parser.c mlp.c mlpdsp.c }
...
contains( CONFIG_VC1_DECODER, yes )             { SOURCES *= vc1dec.c vc1.c vc1data.c vc1dsp.c msmpeg4data.c h263dec.c h263.c intrax8.c intrax8dsp.c error_resilience.c mpegvideo.c msmpeg4.c }
contains( CONFIG_VC1_VAAPI_HWACCEL, yes )       { SOURCES *= vc1dec.c vc1.c vc1data.c vc1dsp.c msmpeg4data.c h263dec.c h263.c intrax8.c intrax8dsp.c error_resilience.c mpegvideo.c msmpeg4.c vaapi_vc1.c }
contains( CONFIG_VC1_VDPAU_DECODER, yes )       { SOURCES *= vc1dec.c vc1.c vc1data.c vc1dsp.c msmpeg4data.c h263dec.c h263.c intrax8.c intrax8dsp.c error_resilience.c mpegvideo.c msmpeg4.c }
...
contains( CONFIG_VP6A_DECODER, yes )            { SOURCES *= vp6.c vp56.c vp56data.c vp3dsp.c vp6dsp.c huffman.c }
contains( CONFIG_VP6F_DECODER, yes )            { SOURCES *= vp6.c vp56.c vp56data.c vp3dsp.c vp6dsp.c huffman.c }
...
contains( CONFIG_WMV3_DECODER, yes )            { SOURCES *= vc1dec.c vc1.c vc1data.c vc1dsp.c msmpeg4data.c h263dec.c h263.c intrax8.c intrax8dsp.c error_resilience.c mpegvideo.c msmpeg4.c }
contains( CONFIG_WMV3_VAAPI_HWACCEL, yes )      { SOURCES *= vc1dec.c vc1.c vc1data.c vc1dsp.c msmpeg4data.c h263dec.c h263.c intrax8.c intrax8dsp.c error_resilience.c mpegvideo.c msmpeg4.c vaapi_vc1.c }
contains( CONFIG_WMV3_VDPAU_DECODER, yes )      { SOURCES *= vc1dec.c vc1.c vc1data.c vc1dsp.c msmpeg4data.c h263dec.c h263.c intrax8.c intrax8dsp.c error_resilience.c mpegvideo.c msmpeg4.c }
...
contains( CONFIG_EAC3_DEMUXER, yes )            { SOURCES *= ac3_parser.c ac3tab.c aac_ac3_parser.c }
...
contains( CONFIG_OGG_DEMUXER, yes )             { SOURCES *= flacdec.c flacdata.c flac.c }
...
contains( CONFIG_LIBOPENCORE_AMRNB, yes )       { SOURCES *= libopencore-amr.c }
contains( CONFIG_LIBOPENCORE_AMRWB, yes )       { SOURCES *= libopencore-amr.c }
contains( CONFIG_LIBOPENJPEG, yes )             { SOURCES *= libopenjpeg.c }
...
contains( CONFIG_LIBSPEEX, yes )                { SOURCES *= libspeexdec.c }
...
contains( CONFIG_VC1_PARSER, yes )              { SOURCES *= vc1_parser.c vc1.c vc1data.c msmpeg4data.c h263dec.c h263.c error_resilience.c intrax8.c mpegvideo.c msmpeg4.c }
contains( CONFIG_VP3_PARSER, yes )              { SOURCES *= vp3_parser.c }

# bitstream filters
contains( CONFIG_AAC_ADTSTOASC_BSF, yes )          { SOURCES *= aac_adtstoasc_bsf.c aac_parser.c mpeg4audio.c }
...
contains( HAVE_MMX, yes ) {
    ...
    contains( CONFIG_FLAC_ENCODER, yes )   { SOURCES *= x86/flacdsp_mmx.c }
    contains( CONFIG_GPL, yes )            { SOURCES *= x86/idct_mmx.c }
    contains( CONFIG_SNOW_DECODER, yes )   { SOURCES *= x86/snowdsp_mmx.c }
    contains( CONFIG_THEORA_DECODER, yes ) { SOURCES *= x86/vp3dsp_mmx.c x86/vp3dsp_sse2.c }
    ...
    contains( CONFIG_VP6A_DECODER, yes )   { SOURCES *= x86/vp3dsp_mmx.c x86/vp3dsp_sse2.c x86/vp6dsp_mmx.c x86/vp6dsp_sse2.c }
    contains( CONFIG_VP6F_DECODER, yes )   { SOURCES *= x86/vp3dsp_mmx.c x86/vp3dsp_sse2.c x86/vp6dsp_mmx.c x86/vp6dsp_sse2.c }
    contains( CONFIG_WMV3_DECODER, yes )   { SOURCES *= x86/vc1dsp_mmx.c }
...
contains( HAVE_NEON, yes ) {
    ...
    SOURCES += arm/dsputil_neon_s.S
    SOURCES += arm/h264dsp_neon.S
    SOURCES += arm/h264idct_neon.S
    SOURCES += arm/simple_idct_neon.S

    contains( CONFIG_THEORA_DECODER, yes ) { SOURCES *= arm/vp3dsp_neon.S }
...
contains( HAVE_ALTIVEC, yes ) {
    ...
    contains( CONFIG_THEORA_DECODER, yes){ SOURCES *= ppc/vp3dsp_altivec.c }
    ...
    contains( CONFIG_VP6A_DECODER, yes ) { SOURCES *= ppc/vp3dsp_altivec.c }
    contains( CONFIG_VP6F_DECODER, yes ) { SOURCES *= ppc/vp3dsp_altivec.c }
