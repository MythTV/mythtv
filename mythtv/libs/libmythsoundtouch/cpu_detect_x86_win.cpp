...
uint detectCPUextensions(void)
{
    ...
    __asm 
    {
		...
		or      esi, MM_MMX			; SUPPORT_MMX ; otherwise add MMX support bit

        test    edx, 0x02000000
        jz      test3DNow           ; branch if SSE not available

        or      esi, MM_SSE		; SUPPORT_SSE    ; otherwise add SSE support bit
    ...
    test3DNow:
        ...
        ; test for precense of 3DNow! extension
			...
			or      esi, MM_MMXEXT	;  SUPPORT_3DNOW; otherwise add 3DNow support bit
