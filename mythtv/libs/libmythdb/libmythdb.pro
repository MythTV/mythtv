...
HEADERS += mythobservable.h mythevent.h httpcomms.h qmdcodec.h
HEADERS += mythtimer.h mythdirs.h mythsocket.h lcddevice.h
HEADERS += exitcodes.h

SOURCES += mythdbcon.cpp mythdb.cpp oldsettings.cpp mythverbose.cpp
SOURCES += mythobservable.cpp httpcomms.cpp qmdcodec.cpp mythdirs.cpp
SOURCES += mythsocket.cpp lcddevice.cpp
...
inc.files += mythobservable.h mythevent.h httpcomms.h qmdcodec.h
