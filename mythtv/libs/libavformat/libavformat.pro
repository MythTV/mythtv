...
contains( CONFIG_DTS_MUXER, yes )                 { SOURCES *= raw.c }
...
contains( CONFIG_EAC3__DEMUXER, yes )             { SOURCES *= raw.c }
...
contains( CONFIG_IPOD_MUXER, yes )                { SOURCES *= movenc.c riff.c isom.c avc.c }
...
contains( CONFIG_MATROSKA_AUDIO_MUXER, yes )      { SOURCES *= matroskaenc.c matroska.c riff.c avc.c }
contains( CONFIG_MATROSKA_DEMUXER, yes )          { SOURCES *= matroskadec.c matroska.c riff.c }
contains( CONFIG_MATROSKA_MUXER, yes )            { SOURCES *= matroskaenc.c matroska.c riff.c avc.c }
contains( CONFIG_MJPEG_DEMUXER, yes )             { SOURCES *= raw.c }
contains( CONFIG_MJPEG_MUXER, yes )               { SOURCES *= raw.c }
contains( CONFIG_MLP_DEMUXER, yes )               { SOURCES *= raw.c }
...
contains( CONFIG_MP4_MUXER, yes )                 { SOURCES *= movenc.c riff.c isom.c avc.c }
...
contains( CONFIG_MXF_MUXER, yes )                 { SOURCES *= mxfenc.c mxf.c }
...
contains( CONFIG_OGG_DEMUXER, yes )               { SOURCES *= oggdec.c oggparsevorbis.c oggparsetheora.c oggparseflac.c oggparseogm.c oggparsespeex.c riff.c }
...
contains( CONFIG_PSP_MUXER, yes )                 { SOURCES *= movenc.c riff.c isom.c avc.c }
...
contains( CONFIG_RTP_MUXER, yes )                 { SOURCES *= rtp.c rtpenc.c rtp_mpv.c rtp_aac.c rtpenc_h264.c avc.c }
contains( CONFIG_RTSP_DEMUXER, yes )              { SOURCES *= rdt.c rtsp.c }
contains( CONFIG_SDP_DEMUXER, yes )               { SOURCES *= rtsp.c rtp.c rtpdec.c rtp_h264.c }
...
contains( CONFIG_TG2_MUXER, yes )                 { SOURCES *= movenc.c riff.c isom.c avc.c }
contains( CONFIG_TGP_MUXER, yes )                 { SOURCES *= movenc.c riff.c isom.c avc.c }
