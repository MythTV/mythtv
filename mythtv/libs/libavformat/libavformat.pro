...
contains( CONFIG_OGG_DEMUXER, yes )               { SOURCES *= ogg2.c oggparsevorbis.c oggparsetheora.c oggparseflac.c oggparseogm.c riff.c }
contains( CONFIG_OGG_MUXER, yes )                 { SOURCES *= ogg.c }
