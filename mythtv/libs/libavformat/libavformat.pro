...
contains( CONFIG_ASF_STREAM_MUXER, yes )          { SOURCES *= asfenc.c riff.c }
...
contains( CONFIG_FLAC_DEMUXER, yes )              { SOURCES *=  flacdec.c raw.c id3v2.c oggparsevorbis.c }
...
contains( CONFIG_MATROSKA_AUDIO_MUXER, yes )      { SOURCES *= matroskaenc.c matroska.c riff.c isom.c avc.c flacenc.c }
...
contains( CONFIG_MPC_DEMUXER, yes )               { SOURCES *= mpc.c id3v2.c }
...
contains( CONFIG_MXF_D10_MUXER, yes )             { SOURCES *= mxfenc.c mxf.c audiointerleave.c }
...
contains( CONFIG_RTP_MUXER, yes )                 { SOURCES *= rtp.c rtpenc.c rtp_mpv.c rtp_aac.c rtp_amr.c rtp_asf.c rtp_h263.c rtpenc_h264.c avc.c }
contains( CONFIG_RTSP_DEMUXER, yes )              { SOURCES *= rdt.c rtsp.c rtp_vorbis.c rtp_asf.c }
contains( CONFIG_SDP_DEMUXER, yes )               { SOURCES *= rtsp.c rtp.c rtpdec.c rtp_h264.c rtp_vorbis.c rtp_asf.c }
...
contains( CONFIG_SOX_DEMUXER, yes )               { SOURCES *= soxdec.c }
