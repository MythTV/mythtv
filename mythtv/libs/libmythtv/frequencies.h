 ...
 */
static constexpr uint16_t NTSC_AUDIO_CARRIER     { 4500 };
static constexpr uint16_t PAL_AUDIO_CARRIER_I    { 6000 };
static constexpr uint16_t PAL_AUDIO_CARRIER_BGHN { 5500 };
static constexpr uint16_t PAL_AUDIO_CARRIER_MN   { 4500 };
static constexpr uint16_t PAL_AUDIO_CARRIER_D    { 6500 };
static constexpr uint16_t SEACAM_AUDIO_DKK1L     { 6500 };
static constexpr uint16_t SEACAM_AUDIO_BG        { 5500 };
...
static constexpr uint16_t NICAM728_PAL_BGH { 5850 };
static constexpr uint16_t NICAM728_PAL_I   { 6552 };
