...
#ifndef _GPUAVDECODER_H_
#define _GPUAVDECODER_H_
...
typedef void (*QueueCallback)(void *, AVStream *, AVPacket *, QMutex *);

/// A decoder for video files.

/// The GPUAvDecoder is used to decode non-NuppleVideo files.
/// It's used as a decoder of last resort after trying the NuppelDecoder
class GPUAvDecoder : public DecoderBase
{
  public:
    ...
    void SetAudioCB(QueueCallback cb, void *arg)
        { m_audioCB = cb; m_audioArg = arg; };
    void SetVideoCB(QueueCallback cb, void *arg)
        { m_videoCB = cb; m_videoArg = arg; };
  ...
  protected:
    ...
    void SeekReset(long long, uint skipFrames, bool doFlush,
                   bool discardFrames);
    ...
    QueueCallback m_audioCB;
    QueueCallback m_videoCB;
    void *m_audioArg;
    void *m_videoArg;
};
