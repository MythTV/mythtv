 ...
 */
#ifndef LIBMYTHTV_TEST_PINK_NOISE_H
#define LIBMYTHTV_TEST_PINK_NOISE_H
...
class TestPinkNoise: public QObject
{
  ...
  private slots:
    static void PinkNoiseGenerator(void)
    {
        ...
        // Most platforms
        std::array<float,16> expected_start = {
        ...
        std::array<float,16> expected_end = {
...
#endif // LIBMYTHTV_TEST_PINK_NOISE_H
