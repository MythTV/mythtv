...
{
    CHECKENABLED;
    LOG(VB_VBI, LOG_INFO, QString("SetCurrentWindow(%1, %2)")
...
{
    CHECKENABLED;
    LOG(VB_VBI, LOG_INFO, QString("DeleteWindows(%1, %2)")
...
{
    CHECKENABLED;
    LOG(VB_VBI, LOG_INFO, QString("HideWindows(%1, %2)")
            .arg(service_num).arg(window_map, 8, 2, QChar(48)));
...
{
    CHECKENABLED;
    LOG(VB_VBI, LOG_INFO, QString("Delay(%1, %2 seconds)")
...
{
    CHECKENABLED;
    LOG(VB_VBI, LOG_INFO, QString("DelayCancel(%1)").arg(service_num));
}

void CC708Reader::Reset(uint service_num)
{
    CHECKENABLED;
    LOG(VB_VBI, LOG_INFO, QString("Reset(%1)").arg(service_num));
