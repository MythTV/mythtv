...
#define LOC QString("FbFeedRtsp(%1):")
#define LOC_ERR QString("FbFeedRtsp(%1), Error:")
...
FreeboxFeederRtsp::FreeboxFeederRtsp() :
    _rtsp_client(NULL),
    _session(NULL)
{
...
bool FreeboxFeederRtsp::CanHandle(const QString &url) const
{
    return url.startsWith("rtsp://", false);
}

bool FreeboxFeederRtsp::Open(const QString &url)
{
...
void FreeboxFeederRtsp::Close(void)
{
...
void FreeboxFeederRtsp::AddListener(IPTVListener *item)
{
...
void FreeboxFeederRtsp::RemoveListener(IPTVListener *item)
{
