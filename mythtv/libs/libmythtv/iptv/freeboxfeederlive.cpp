...
FreeboxFeederLive::FreeboxFeederLive() :
    _abort(0),
    _running(false),
    _live_env(NULL),
    _lock(false)
...
bool FreeboxFeederLive::InitEnv(void)
{
    if (_live_env)
    {
...
void FreeboxFeederLive::FreeEnv(void)
{
    if (_live_env)
    {
...
void FreeboxFeederLive::Run(void)
{
...
void FreeboxFeederLive::Stop(void)
{
