...
#define LOC QString("FbFeedUdp: ")


FreeboxFeederUdp::FreeboxFeederUdp() :
    _source(NULL),
    _sink(NULL)
{
...
bool FreeboxFeederUdp::CanHandle(const QString &url) const
{
    return url.startsWith("udp://", false);
}

bool FreeboxFeederUdp::Open(const QString &url)
{
...
void FreeboxFeederUdp::Close(void)
{
...
void FreeboxFeederUdp::AddListener(IPTVListener *item)
{
...
void FreeboxFeederUdp::RemoveListener(IPTVListener *item)
{
