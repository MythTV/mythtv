...
#define LOC QString("FbFeedRtp: ")


FreeboxFeederRtp::FreeboxFeederRtp() :
    _source(NULL),
    _sink(NULL)
{
...
bool FreeboxFeederRtp::CanHandle(const QString &url) const
{
    return url.startsWith("rtp://", false);
}

bool FreeboxFeederRtp::Open(const QString &url)
{
...
void FreeboxFeederRtp::Close(void)
{
...
void FreeboxFeederRtp::AddListener(IPTVListener *item)
{
...
void FreeboxFeederRtp::RemoveListener(IPTVListener *item)
{
