...
void strings_null() {
    ...
    ThemeUI::tr("My speaker supports E-AC-3");
    ThemeUI::tr("My speaker supports TrueHD");
    ThemeUI::tr("My speaker supports DTS-HD");
    ...
    ThemeUI::tr("Designed to show off some different element arrangements available in Myth 0.25.  Tested at 1280x720 and with Fran̤ais");
    ThemeUI::tr("Year: %1");
    ThemeUI::tr("IMDB: %1");
    ThemeUI::tr("No videos in library,or no files found.  If you have configured a video directory,press \"M\" (or the MENU key) and select \"Scan for Changes.\"");
