...
#define FFMPEG_CONFIGURATION "--compile-type=debug --enable-libmp3lame --enable-libx264 --enable-libvpx --enable-sdl --enable-nonfree --disable-distcc"
#define FFMPEG_LICENSE ""
#define FFMPEG_DATADIR "/usr/local/share/mythtv"
#define AVCONV_DATADIR "/usr/local/share/mythtv"
#define CC_IDENT "gcc 4.7 (Ubuntu/Linaro 4.7.3-1ubuntu1)"
...
#define CONFIG_MYTHTV_MPEGTS_DEMUXER 1
#define CONFIG_MPEGTSRAW_DEMUXER 0
#define CONFIG_MYTHTV_MPEGTSRAW_DEMUXER 1
...
#define CONFIG_AUDIO_PULSE 0
#define CONFIG_AUDIO_PULSEOUTPUT 0
#define CONFIG_AUDIO_ALSA 0
#define CONFIG_AUDIO_JACK 0
#define CONFIG_AUDIO_OSS 0
#define CONFIG_FFMPEG_PTHREADS 1
#define CONFIG_MAC_BUNDLE 0
#define CONFIG_PROC_OPT 0
#define CONFIG_SILENT_CC 0
#define CONFIG_SYMBOL_VISIBILITY 1
#define CONFIG_BACKEND 1
#define CONFIG_BINDINGS_PERL 0
#define CONFIG_BINDINGS_PYTHON 0
#define CONFIG_BINDINGS_PHP 1
#define CONFIG_CRYSTALHD 0
#define CONFIG_CYGWIN 0
#define CONFIG_DARWIN 0
#define CONFIG_DISABLE_MMX_FOR_DEBUGGING 0
#define CONFIG_DVB 1
#define CONFIG_FIREWIRE 0
#define CONFIG_FRONTEND 1
#define CONFIG_HDHOMERUN 1
#define CONFIG_CETON 1
#define CONFIG_HDPVR 1
#define CONFIG_IVTV 1
#define CONFIG_ASI 0
#define CONFIG_JOYSTICK_MENU 1
...
#define CONFIG_MHEG 1
#define CONFIG_OPENGL 1
#define CONFIG_OPENGL_VIDEO 1
#define CONFIG_QTWEBKIT 1
#define CONFIG_QTSCRIPT 1
#define CONFIG_QTDBUS 0
#define CONFIG_QUARTZ_VIDEO 0
#define CONFIG_SDL 1
