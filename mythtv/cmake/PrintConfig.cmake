...
if(NOT "${quiet}" STREQUAL "yes")
  ...
  # The majority of the items below are a holdover from the original
  # configure script that was based on the FFmpeg configure script.
  ...
  elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "ppc|powerpc")
    message_vrbl("AltiVec enabled         " HAVE_ALTIVEC)
...
if(ENABLE_FRONTEND)
  ...
  message_trgt("ALSA support            " ALSA::ALSA)
  ...
  if(TARGET X11::X11)
    ...
    message_trgt("NVDEC support           " PkgConfig::FFNVCODEC)
  endif()
  if(APPLE)
