  ...
  if(TARGET Vulkan::Vulkan)
    ...
    if(ENABLE_GLSLANG AND NOT CMAKE_CROSSCOMPILING)
      ...
      if(TARGET PkgConfig::GLSLANG)
        ...
        file(READ ${GLSLANG_INCLUDEDIR}/glslang/Include/ResourceLimits.h _limits)
        string(FIND "${_limits}" "maxMeshOutputVerticesEXT" POS)
        if(NOT POS EQUAL -1)
          set(HAVE_TBUILTINRESOURCE_EXT_FIELDS ON)
        endif()
