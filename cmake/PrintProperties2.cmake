...
# build whitelist by filtering down from CMAKE_PROPERTY_LIST in case cmake is a
# different version, and one of our hardcoded whitelisted properties doesn't
# exist!
unset(CMAKE_WHITELISTED_PROPERTY_LIST)
foreach(prop IN LISTS CMAKE_PROPERTY_LIST)
  if(prop
     MATCHES
...
function(print_target_properties tgt)
  ...
  foreach(prop IN LISTS PROP_LIST)
